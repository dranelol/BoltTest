...
internal class Messenger : MonoBehaviour
{
    ...
    static private MessengerManager messengerManager = (new GameObject("MessengerManager")).AddComponent<MessengerManager>();
...
public sealed class MessengerManager : MonoBehaviour
{
    void Awake()
    {
